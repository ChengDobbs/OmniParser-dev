...
class Omniparser(object):
    ...
    def parse(self, image_base64: str, preserve_text_priority: bool = True, text_overlap_threshold: float = 0.5, **kwargs):
        """
        ...
        default_params = {
            ...
            'scale_img': False,
            'batch_size': 128,
            'preserve_text_priority': preserve_text_priority,
            'text_overlap_threshold': text_overlap_threshold
        }
        default_params.update(kwargs)
        
        dino_labled_img, label_coordinates, parsed_content_list = get_som_labeled_img(image, self.som_model, **default_params)
